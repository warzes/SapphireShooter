...
struct RandomAccessIterator
{
	...
	explicit RandomAccessIterator(T* ptr_) : ptr(ptr_) {}
...
struct RandomAccessConstIterator
{
	...
	explicit RandomAccessConstIterator(T* ptr_) : ptr(ptr_) {}
	RandomAccessConstIterator(const RandomAccessIterator<T>& it) : ptr(it.ptr) {}
