...
void Renderer::Initialize()
{
    ...
    faceSelectionTexture1 = new Texture2();
    faceSelectionTexture2 = new Texture2();
...
void Renderer::LoadPassShaders(Pass* pass)
{
    ...
    #if SE_OPENGL
    pass->shaders[SHADER_VS] = cache->LoadResource<Shader2>(pass->ShaderName(SHADER_VS) + ".vert");
    pass->shaders[SHADER_PS] = cache->LoadResource<Shader2>(pass->ShaderName(SHADER_PS) + ".frag");
    #else
    pass->shaders[SHADER_VS] = cache->LoadResource<Shader2>(pass->ShaderName(SHADER_VS) + ".vs");
    pass->shaders[SHADER_PS] = cache->LoadResource<Shader2>(pass->ShaderName(SHADER_PS) + ".ps");
    #endif
